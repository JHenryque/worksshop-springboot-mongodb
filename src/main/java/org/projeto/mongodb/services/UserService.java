...
public class UserService {
    ...
    public User findById(String id) {
        ...
        return user.orElseThrow(() -> new ObjetNotFoundException("Objeto não encontrado"));
    }
    ...
    public User fromDTO(UserDTO objetDto) {
        return new User(objetDto.getId(), objetDto.getName(), objetDto.getEmail());
    }
}
